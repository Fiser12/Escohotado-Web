...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "article_pdf_rels" ADD COLUMN "taxonomy_id" uuid;
  ALTER TABLE "article_web_rels" ADD COLUMN "taxonomy_id" uuid;
  ALTER TABLE "video_rels" ADD COLUMN "taxonomy_id" uuid;
  ALTER TABLE "quote_rels" ADD COLUMN "taxonomy_id" uuid;
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "taxonomy_id" uuid;
  DO $$ BEGIN
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "article_pdf_rels" DROP CONSTRAINT "article_pdf_rels_taxonomy_fk";
  
  ALTER TABLE "article_web_rels" DROP CONSTRAINT "article_web_rels_taxonomy_fk";
  
  ALTER TABLE "video_rels" DROP CONSTRAINT "video_rels_taxonomy_fk";
  
  ALTER TABLE "quote_rels" DROP CONSTRAINT "quote_rels_taxonomy_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_taxonomy_fk";
