...
const Page = async () => {
    return <ContentWrapper className="pt-10 flex flex-col items-right gap-6">ç
        <Typo.H1>Aviso de Privacidad</Typo.H1>
        ...
        <Typo.H4 >RESUMEN DE PUNTOS CLAVE</Typo.H4>
        <p>
        ...
        <Typo.H4 >1. ¿QUÉ INFORMACIÓN PERSONAL RECOPILAMOS?</Typo.H4>
        ...
        <Typo.H4 >2. ¿CÓMO PROCESAMOS SU INFORMACIÓN?</Typo.H4>
        <p>
        ...
        <Typo.H4 >3. ¿CUÁLES SON LAS BASES LEGALES PARA PROCESAR SU INFORMACIÓN?</Typo.H4>
        <p>
        ...
        <Typo.H4 >4. ¿CUÁNDO Y CON QUIÉN COMPARTIMOS SU INFORMACIÓN PERSONAL?</Typo.H4>
        <p>
        ...
        <Typo.H4 >5. ¿CÓMO MANEJAMOS LOS INICIOS DE SESIÓN SOCIAL?</Typo.H4>
        <p>
        ...
        <Typo.H4 >6. ¿POR CUÁNTO TIEMPO CONSERVAMOS SU INFORMACIÓN?</Typo.H4>
        <p>
        ...
        <Typo.H4 >7. ¿CÓMO MANTENEMOS SEGURA SU INFORMACIÓN?</Typo.H4>
        <p>
        ...
        <Typo.H4 >8. ¿RECOPILAMOS INFORMACIÓN DE MENORES?</Typo.H4>
        <p>
        ...
        <Typo.H4 >9. ¿CUÁLES SON SUS DERECHOS DE PRIVACIDAD?</Typo.H4>
        <p>
        ...
        <Typo.H4 >10. CONTROLES DE COOKIES Y PUBLICIDAD EN LÍNEA</Typo.H4>
        <p>
        ...
        <Typo.H4 >11. ¿QUÉ DATOS ALMACENAMOS?</Typo.H4>
        <p>
        ...
        <Typo.H4 >12. ¿ACTUALIZAMOS ESTE AVISO?</Typo.H4>
        <p>
        ...
        <Typo.H4 >13. ¿CÓMO PUEDE CONTACTARNOS SOBRE ESTE AVISO?</Typo.H4>
        <p>
