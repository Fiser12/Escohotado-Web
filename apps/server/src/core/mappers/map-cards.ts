import { getArticlesQueryWithCache } from '@/core/queries/get-articles-query'
import { getQuotesQueryWithCache } from '@/core/queries/get-quotes-query'
import { getVideosQueryWithCache } from '@/core/queries/get-videos-query'
import 'hegel'
...
import { ArticleWeb, Book, GridCardsBlock, Media, Taxonomy, UiGridCard, Video } from 'payload-types'
...
} from '@/core/mappers/map-taxonomy-to-category-model'
