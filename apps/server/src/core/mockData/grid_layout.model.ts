...
export const featuredItem: { gridClassname: string, features: ContentCardModel[] } = {
...
export const featuredGrid01: { gridClassname: string, features: ContentCardModel[] } = {
  gridClassname: "grid-cols-1 sm:grid-cols-4 md:grid-cols-5",
  features: [
        {
              id: 1,
...
export const featuredGrid02: { gridClassname: string, features: ContentCardModel[] } = {
...
export const featuredGrid03: { gridClassname: string, features: ContentCardModel[] } = {
  gridClassname: "grid-cols-1 sm:grid-cols-4 lg:grid-cols-5",
  features: [
        {
              id: 1,
